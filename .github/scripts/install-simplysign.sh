...
if curl -L "https://files.certum.eu/software/SimplySignDesktop/Windows/9.1.5.52/SimplySignDesktop-9.1.5.52-64-bit-en.msi" -o "$CERTUM_INSTALLER" --fail --max-time 60; then
