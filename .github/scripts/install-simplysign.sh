...
if curl -L "https://files.certum.eu/software/SimplySignDesktop/Windows/8.3.3.52/SimplySignDesktop-8.3.3.52-64-bit-en.msi" -o "$CERTUM_INSTALLER" --fail --max-time 60; then
