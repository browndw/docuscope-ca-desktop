...
if curl -L "https://files.certum.eu/software/SimplySignDesktop/Windows/9.1.11.61/SimplySignDesktop-9.1.11.61-64-bit-en.msi" -o "$CERTUM_INSTALLER" --fail --max-time 60; then
